...
PCExecutor = (function(_super) {
  __extends(PCExecutor, _super);

  function PCExecutor() {
    _ref4 = PCExecutor.__super__.constructor.apply(this, arguments);
    return _ref4;
  }

  PCExecutor.prototype._printStep = function(step) {
  ...
  PCExecutor.prototype._printExecutionIntro = function() {
    return this._output("<i>Starting CCS execution.</i>");
  };

  PCExecutor.prototype._printExecutionSummary = function() {
    var elapsedMS, perStep;
    elapsedMS = (new Date()).getTime() - this.executionStart.getTime();
    perStep = Math.round(elapsedMS / this.stepCount * 100) / 100;
